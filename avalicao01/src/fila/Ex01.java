...
public class Ex01 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("4 - Remove da lista");
            ...
            if (op == 1) {
                ...
                /*LISTA preco = new LISTA();
					LISTA cod = new LISTA();
					LISTA quantidade = new LISTA();
                 */
                LISTA novo = new LISTA();

                System.out.println("Digite o codido ");
                novo.cod = entrada.nextInt();

                System.out.println("preco ");
                novo.preco = entrada.nextFloat();

                System.out.println("quantidade");
                novo.quantidade = entrada.nextInt();
            ...
            if (op == 2) {
                ...
                if (inicio == null) {
                    ...
                    // a lista estava vazia
                    // e o elemento inserido será o primeiro e o ultim
                    inicio = novo;
                    fim = novo;
                    novo.proxi = null;
                    ...
                    // a lista ja contem elementos e o novo seera inserido no fim da lista
                    fim.proxi = novo;
                    fim = novo;
                    fim.proxi = null;
                }
            ...
            if (op == 3) {
                if (inicio == null) {
                    ...
                    auxi.desconto = entrada.nextInt();
                    while (auxi != null) {

                        System.out.println("codigo " + auxi.cod + "    ");
                        System.out.println("preco " + auxi.preco + "    ");
                        System.out.println("quantidade " + auxi.quantidade + "    ");

                        System.out.println("o valor do com desconto sera" + (auxi.preco - ((auxi.desconto / 100) * auxi.preco)));

                        if (auxi.quantidade >= 500) {

                            System.out.println("Produto com estoque superior a 500 " + auxi.cod);

                        } else {

                            System.out.println("nenhum produto acima de 500");
                        }
